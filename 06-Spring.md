...
![image-20201020183306246](./img/image-20201020183306246.png)
...
@Component和@Bean都是用来注册Bean并装配到Spring容器中，但是Bean比Component的自定义性更强。@Component 作用于类，@Bean作用于方法。@Component倾向于组件扫描和自动装配。
 但有时自动设置是做不到的。
